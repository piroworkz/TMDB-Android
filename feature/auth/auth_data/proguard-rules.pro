...
-keep @kotlinx.serialization.Serializable class com.davidluna.tmdb.auth_data.data.remote.model.** { *; }
...
-keep class com.davidluna.tmdb.auth_data.** { *; }
-dontwarn com.davidluna.tmdb.auth_data.**
