...
-keep @kotlinx.serialization.Serializable class com.davidluna.tmdb.core_data.data.remote.model.** { *; }
...
-keep class com.davidluna.tmdb.core_data.** { *; }
-dontwarn com.davidluna.tmdb.core_data.**